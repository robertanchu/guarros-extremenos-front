...
export default function Footer(){ return (<footer className="mt-16 border-t border-white/10"><div className="container py-10 grid md:grid-cols-4 gap-6 text-sm text-zinc-300">
...
</div><div className="py-4 text-center text-xs text-zinc-500">© {new Date().getFullYear()} Guarros Extremeños</div></footer>); }
