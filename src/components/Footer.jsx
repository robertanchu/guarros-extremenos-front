          ...
          <div>
            ...
            <form onSubmit={(e)=>e.preventDefault()} className="mt-4">
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                <button type="submit" className="group relative inline-flex-1 h-10 justify-center rounded-xl px-6 py-3 text-base font-stencil tracking-wide text-black bg-[#E53935] transition-colors duration-200 shadow-lg hover:bg-[#992623] focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 active:scale-[0.98]"
            >
