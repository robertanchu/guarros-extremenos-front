        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex gap-4">
            ...
            >
              ...
              <span className="pointer-events-none absolute inset-0 rounded-xl ring-2 ring-[#E53935]/50 group-hover:ring-[#992623]/50 transition-all"></span>
            </Link>
...
function Ticker(){
  const items = [
    "Jamón 10// src/components/HeroPlus.jsx
import { motion } from "framer-motion";
import { Link } from "react-router-dom";
